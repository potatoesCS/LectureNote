...
- Contiguous Allocation 연속 할당
    - 하나의 파일이 디스크 상에서 연속해서 저장(인접한 블럭 번호 가지도록 저장)
        ![운영체제 이미지](운영체제1.png){:height="100px" width="100px"}
...
- Linked Allocation 연결 할당
    - 연속하지 않고 빈 위치 아무데나 파일 할당. (앞서 연속할당에서 본 외부 조각 막기 위해.)
        ...
        ![운영체제 이미지](운영체제2.png){:height="100px" width="100px"}
...
- Indexed Allocation
    - directory에 파일 위치 정보 바로 저장하는 게 아니라 인덱스 저장
        ...
        ![운영체제 이미지](운영체제3.png){:height="100px" width="100px"}
...
![운영체제 이미지](운영체제4.png){:height="100px" width="100px"}
...
3. Inode list
    - directory가 파일의 모든 meta data를 갖는 게 아니라 일부만 갖고 있고, meta data는 따로 빼서 저장 ⇒ 이 meta data 저장 위치가 바로 inode list
        ...
        ![운영체제 이미지](운영체제5.png){:height="100px" width="100px"}
...
![운영체제 이미지](운영체제6.png){:height="100px" width="100px"}
